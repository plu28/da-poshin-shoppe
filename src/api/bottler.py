...
def post_deliver_bottles(potions_delivered: list[PotionInventory], order_id: int):
    ...
    for potion in potions_delivered:
        ...
        catalog_row = ct.CatalogInventory().retrieve(sku) # bad transaction
        ...
        # Doing a transaction for every potion delivered
        if (catalog_row == None):
            ...
            # Update existing sku
            # Instead of updating the sku, just insert a row
